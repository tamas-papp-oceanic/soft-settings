...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let t2;
    	let p;
    	document.title = title_value = "" + (/*appName*/ ctx[1] + " [v" + /*version*/ ctx[0] + "]");
    	...
    	const block = {
    		c: function create() {
    			...
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Hello from Electron renderer!";
    			t2 = space();
    			p = element("p");
    			p.textContent = "👋";
    			add_location(h1, file, 205, 2, 9587);
    			add_location(p, file, 206, 1, 9627);
    			attr_dev(main, "class", "content");
    			add_location(main, file, 187, 0, 8943);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*appName, version*/ 3 && title_value !== (title_value = "" + (/*appName*/ ctx[1] + " [v" + /*version*/ ctx[0] + "]"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['version', 'appName'];
    	...
    	$$self.$capture_state = () => ({ version, appName });
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { version: 0, appName: 1 });
